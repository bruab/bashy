...
(function() {
  var BashyOS, BashySprite, DisplayManager, Task, TaskManager, validPath,
  ...
  Task = (function() {
    function Task(name, hints, tests) {
      this.name = name;
      this.hints = hints;
      this.tests = tests;
  ...
  jQuery(function() {
    ...
    return startGame = function() {
      var bashySpriteSheet, bashy_sprite, display_mgr, handleInput, homeText, line1, line2, mediaText, my_task, os, rootText, sprite, task_mgr, tick;
