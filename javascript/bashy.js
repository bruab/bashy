...
(function() {
  var BashyGame, BashyOS, Directory, DisplayManager, File, FileSystem, Level, Man, Task, TaskManager, Terminal, getLevelFourTasks, getLevelOneTasks, getLevelThreeTasks, getLevelTwoTasks, getLevels,
  ...
  getLevelFourTasks = function() {
    var task1, task1Function, task2, task2Function;
    task1Function = function(os) {
      return os.lastCommand().slice(0, 4) === "grep" && os.lastCommandSucceeded;
    };
    task2Function = function(os) {
      return os.lastCommand().slice(0, 4) === "grep" && os.lastCommandSucceeded;
    };
  ...
  getLevels = function() {
    var levelFour, levelFourTasks, levelOne, levelOneTasks, levelThree, levelThreeTasks, levelTwo, levelTwoTasks;
    ...
    levelFour = new Level("Level Four - Filtering Files", "Get only the parts of a file that you want", levelFourTasks);
