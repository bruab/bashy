...
(function() {
  var BashyGame, BashyOS, Directory, DisplayManager, FileSystem, MenuManager, SoundManager, Task, TaskManager, Zone, calculateChildCoords, cleanPath, createBashyOS, createBashySprite, createFileSystem, drawChildren, drawFile, findFileCoords, getParentPath, getTasks, helpScreen, introScreen, parseRelativePath, startTicker,
  ...
  DisplayManager = (function() {
    ...
    DisplayManager.prototype.spriteLoaded = function() {
      this.bashySprite = createBashySprite(this.bashyImage, this.stage);
      return startTicker(this.stage);
    };
  ...
  Zone = (function() {
    function Zone(displayMgr, soundMgr, taskMgr, os1) {
