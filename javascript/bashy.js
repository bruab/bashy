...
(function() {
  var BashyGame, BashyOS, Directory, DisplayManager, FileSystem, Man, Task, TaskManager, Terminal,
  ...
  Man = (function() {
    ...
    Man.prototype.getEntry = function(command) {
      if (indexOf.call(this.entries, command) >= 0) {
        return this.entries[command];
      } else {
