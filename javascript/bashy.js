...
(function() {
  var BashyOS, BashySprite, DisplayManager, File, FileSystem, MenuManager, SoundManager, Task, TaskManager, Util, calculateChildCoords, cleanPath, createBashySprite, drawChildren, drawFile, drawFileSystem, drawLines, getParentPath, get_tasks, helpScreen, playIntro, showHomeText, showMediaText, showRootText, startTicker,
  ...
  jQuery(function() {
    var bashy_himself, canvas, seenIntro, sound_mgr, stage, startGame, util;
    util = new Util();
    ...
    return startGame = function() {
      var bashy_sprite, display_mgr, executeCommand, file_system, handleInput, menu_mgr, os, task_mgr;
      sound_mgr.soundOff();
