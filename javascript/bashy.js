...
(function() {
  var BashyController, BashyOS, BashySprite, DisplayManager, File, FileSystem, MenuManager, SoundManager, Task, TaskManager, Util, calculateChildCoords, cleanPath, createBashySprite, drawChildren, drawFile, drawFileSystem, drawLines, getParentPath, get_tasks, helpScreen, playIntro, showHomeText, showMediaText, showRootText, startGame, startTicker,
  ...
  startGame = function(util, sound_mgr, stage, bashy_himself) {
    var bashy_sprite, controller, display_mgr, file_system, handleInput, menu_mgr, os, task_mgr;
    sound_mgr.soundOff();
    ...
    handleInput = function(input) {
      ...
      if (indexOf.call(os.validCommands(), command) < 0) {
        ...
        return controller.executeCommand(command, args);
      }
    };
