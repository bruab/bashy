...
(function() {
  var BashyController, BashyOS, DisplayManager, File, FileSystem, HelpManager, MenuManager, SoundManager, Task, TaskManager, calculateChildCoords, cleanPath, createBashySprite, drawChildren, drawFile, findFileCoords, getParentPath, getTasks, parseCommand, startTicker,
  ...
  jQuery(function() {
    ...
    return bashyImage.onload = function() {
