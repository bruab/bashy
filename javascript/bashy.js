...
(function() {
  var BashyGame, BashyOS, Directory, DisplayManager, FileSystem, MenuManager, Task, TaskManager, Zone, cleanPath, createFileSystem, getParentPath, parseRelativePath,
  ...
  BashyOS = (function() {
    function BashyOS(zoneName) {
      ...
      if (zoneName === "nav") {
        ...
        this.fileSystem = createFileSystem(zoneName);
      } else {
