...
(function() {
  var BashyOS, BashySprite, DisplayManager, MenuManager, Task, TaskManager, get_tasks, validPath,
  ...
  jQuery(function() {
    ...
    return startGame = function() {
      var bashySpriteSheet, bashy_sprite, display_mgr, handleInput, homeText, line1, line2, mediaText, menu_mgr, os, rootText, sprite, task_mgr, tick;
