...
(function() {
  var BashyOS, BashySprite, DisplayManager, File, FileSystem, MenuManager, Task, TaskManager, calculateChildCoords, createBashySprite, drawFile, drawFileSystem, drawLines, get_tasks, helpScreen, playIntro, showHomeText, showMediaText, showRootText, startTicker, validPath,
  ...
  TaskManager = (function() {
    ...
    TaskManager.prototype.update = function(os) {
      var all_complete, j, len, ref, task;
      all_complete = true;
      ref = this.tasks;
      for (j = 0, len = ref.length; j < len; j++) {
        task = ref[j];
  ...
  drawFileSystem = function(stage, fs) {
    ...
    results = [];
    for (i = j = 0, ref1 = numChildren - 1; 0 <= ref1 ? j <= ref1 : j >= ref1; i = 0 <= ref1 ? ++j : --j) {
