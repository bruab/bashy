...
(function() {
  var BashyController, BashyGame, BashyOS, DisplayManager, File, FileSystem, MenuManager, SoundManager, Task, TaskManager, calculateChildCoords, cleanPath, createBashySprite, createDisplayManager, drawChildren, drawFile, findFileCoords, getParentPath, getTasks, helpScreen, introScreen, parseCommand, startTicker,
  ...
  BashyController = (function() {
    function BashyController(os1, taskMgr, displayMgr1, soundMgr) {
      this.os = os1;
